...
CREATE TABLE SanPham (MaSP int NOT NULL, MaNCC int NOT NULL, MaLoai int NOT NULL, TenSp nvarchar(255) NULL, GiaSp float(10) NOT NULL, PRIMARY KEY (MaSP));
...
CREATE TABLE HoaDon (MaHD int NOT NULL, MaNV int NOT NULL, MaKH int NOT NULL, TongTien float(10) NOT NULL, NgayMua date NULL, PRIMARY KEY (MaHD));
...
CREATE TABLE DonDatHang (MaDDH int NOT NULL, maKH int NOT NULL, TongTien float(10) NOT NULL, NgayDat date NULL, tinhTrang int NULL, PRIMARY KEY (MaDDH));
